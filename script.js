...
var hris = ["hris0", "hris1", "hris2", "hris3", "hris4", "hris5", "hris6"];
...
document.getElementById("down").addEventListener("click", function () {
  ...
  setTimeout(function () {
    document
      .getElementById(titles[currentSection])
      .classList.toggle("show-name");
